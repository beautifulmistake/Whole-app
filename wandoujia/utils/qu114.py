...
base_url = 'http://www.qu114.com/city.aspx'     # 各个地区的链接
cates = [
    {"cate_name": "工商注册", 'cate_url': 'zhuce/'},
    {"cate_name": "商标专利", 'cate_url': 'zhuanli/'}
]
...
def get_start_urls():
    ...
    # 解析页面获取所有的地区名称和链接
    all_cities = html.xpath('//dl[@id="clist"]/dd[position()>1]/a')
...
def record_result(data):
    ...
    :return:
    """
    path = r'G:\工作\APP\wandoujia\Qu114_city.json'
