...
base_url = 'http://www.juhebang.com/changecity.php'     # 各个地区的链接
cates = [
    {"cate_name": "工商注册", 'cate_url': 'gongshangzhuce/'},
    {"cate_name": "商标专利", 'cate_url': 'shangbiaozhuanli/'}
]
...
def get_start_urls():
    ...
    # 解析页面获取所有的地区名称和链接
    all_cities = html.xpath('//dl[@id="clist"]/div[@class="lister"]/dd/a')
...
def record_result(data):
    ...
    :return:
    """
    path = r'G:\工作\APP\wandoujia\jhb_city.json'
